programa {
  ...
  funcao jogadaX(){
    faca{
      ...
      limpa()
      se(jogo[linha-1][coluna-1]=='X' ou jogo[linha-1][coluna-1]=='O'){
  ...
  funcao logico eVencedor(){
    ...
    senao se(jogo[2][0]==jogo[1][1] e jogo[2][0]==jogo[2][2] e jogo[0][2] != '_'){
      escreva("O jogador ", jogo[0][0], " venceu essa partida.")
      vencedor = jogo[2][0]
      retorne verdadeiro
    } senao retorne falso
