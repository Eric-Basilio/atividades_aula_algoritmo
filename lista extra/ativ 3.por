programa {
  ...
  inteiro contador_outros=0

    funcao mostra_lanches(){
      para(inteiro i=0; i<4; i++){
      escreva(i, " - ", lanche[i])
      escreva(" ------")
      escreva(" R$:", preco_lanche[i], "\n")
    }
    }
    funcao mostra_lanches_escolhidos(){
      para(inteiro i=contador_lanche; i>0; i--){
          ...
          escreva(" ------")
          escreva(" R$:", preco_lanche[lanche_escolhido])
        }
    }
    funcao mostra_bebidas(){
      para(inteiro i=0; i<4; i++){
        escreva(i, " - ", bebidas[i])
        escreva(" ", tamanho_bebidas[i], "ml")
        escreva(" ------")
        escreva(" R$:", preco_bebidas[i], "\n")
    }
    }
    funcao mostra_bebidas_escolhidas(){
      para(inteiro i=contador_bebidas; i>0; i--){
          ...
          escreva(" ------")
          escreva(" R$:", preco_bebidas[bebidas_escolhido])
        }
    }
    funcao mostra_outros(){
      para(inteiro i=0; i<4; i++){
      escreva(i, " - ", outros[i])
      escreva(" ", tamanho_outros[i])
      escreva(" ------")
      escreva(" R$:", preco_outros[i], "\n")
    }
    }
  ...
  funcao inicio() {
    ...
    tamanho_bebidas[0] = "200"
    tamanho_bebidas[1] = "500"
    tamanho_bebidas[2] = "200"
    tamanho_bebidas[3] = "500"

    preco_bebidas[0] = 2.30
    preco_bebidas[1] = 4.00
    preco_bebidas[2] = 3.50
    preco_bebidas[3] = 6.00

    outros[0] = "Batatas Fritas"
    outros[1] = "Batatas Fritas"
    outros[2] = "Batatas Fritas"
    outros[3] = "Salada"

    tamanho_outros[0] = "Pequena"
    tamanho_outros[1] = "Média"
    tamanho_outros[2] = "Grande"
    tamanho_outros[3] = "Média"
    ...
    faca{
      ...
      faca{
        ...
        total_lanche = total_lanche + preco
        escreva("\nTotal: R$",total_lanche)
        escreva("\nDeseja escolher mais algum lanche?")
        escreva("\n[1] SIM\n[2] NÃO\nEscolha: ")
        leia(opcao)
        limpa()
      }enquanto(opcao != 2)
      ...
      faca{
        ...
        total_bebidas = total_bebidas + preco
        escreva("\nTotal: R$",total_bebidas)
        escreva("\nDeseja escolher mais algum bebidas?")
        escreva("\n[1] SIM\n[2] NÃO\nEscolha: ")
        leia(opcao)
        limpa()
      }enquanto(opcao != 2)
      ...
      faca{
        ...
        total_outros = total_outros + preco
        escreva("\nTotal: R$",total_outros)
        escreva("\nDeseja escolher mais algum outros?")
        escreva("\n[1] SIM\n[2] NÃO\nEscolha: ")
        leia(opcao)
        limpa()
      }enquanto(opcao != 2)
